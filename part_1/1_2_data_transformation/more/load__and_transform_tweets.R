# This script transforms the tweets from its original format to an RDS-format.
# You don't have to run this script, the .rds file is part of this project. 
# The script is merely here to give you the complete picture and to highlight
# some aspects of data transformation with R.
...
# 5. Save the tweets as R-native format for faster reload later... ####
